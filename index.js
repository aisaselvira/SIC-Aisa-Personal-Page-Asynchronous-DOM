fetch('https://api.github.com/users/aisaselvira')
  ...
  .then(data => {
    ...
    document.getElementById('button-name').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";
    ...
    document.getElementById('button-id').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";
    ...
    document.getElementById('button-twitter').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";
    ...
    document.getElementById('button-url').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";
    ...
    document.getElementById('button-followers').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";
    ...
    document.getElementById('button-following').style.boxShadow = "10px 6px 10px rgba(31, 16, 80, 0.65)";

    document.getElementById('username').style.width = "240px";
    ...
    document.getElementById('twitter').style.width = "240px";
    ...
    document.getElementById('url').style.width = "280px";
    ...
    document.getElementById('followers').style.width = "240px";
    ...
    document.getElementById('following').style.width = "240px";
